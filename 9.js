...
function paperRequirements(firstBookQuantity, secondBookQuantity, thirdBookQuantity) {
    const firstbookPages = 100 * firstBookQuantity;
    const secondBookPages = 200 * secondBookQuantity;
    const thirdBookPages = 300 * thirdBookQuantity;
    const totalBookpages = firstbookPages + secondBookPages + thirdBookPages;
    return totalBookpages;
}

let bookCopy = paperRequirements(3, 3, 2);
